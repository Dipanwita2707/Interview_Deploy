...
export const resultsAnalyticsArticles: DocArticle[] = [
  {
    ...
    content: () => (
      <>
        ...
        <h2>AI Analysis</h2>
        <p>
          After a candidate completes a session, SMART Interview Platform automatically produces:
        </p>
        <ul>
        ...
        <p>
          For interviews with research-type questions, SMART Interview Platform also extracts structured findings: <strong>topics</strong> (themes, pain points, preferences) and <strong>data points</strong> (specific facts, numbers, or statements). Topics help you spot patterns across sessions; data points give you quotable evidence for reports.
        </p>
        ...
        <p>
          SMART Interview Platform analyzes the candidate&apos;s communication style across every response — detecting confidence level, tone consistency, and clarity. Each question is rated for tone (e.g., Confident, Neutral) and impact (High, Low), giving you a quick read on how the candidate communicates under interview conditions.
        </p>
