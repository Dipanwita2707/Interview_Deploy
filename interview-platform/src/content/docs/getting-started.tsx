...
export const gettingStartedArticles: DocArticle[] = [
  {
    ...
    title: "What is SMART Interview Platform?",
    ...
    content: () => (
      <>
        ...
        <p>
          SMART Interview Platform is an AI-powered interview platform that conducts structured interviews autonomously. You design an interview, share a link, and SMART Interview Platform&apos;s AI handles the conversation — asking questions, probing with follow-ups, and generating detailed analysis when the session is complete.
        </p>
