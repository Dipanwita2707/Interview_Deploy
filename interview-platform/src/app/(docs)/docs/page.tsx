...
export const metadata = {
  title: "Docs | SMART Interview Platform",
  description:
    "Learn how to use SMART Interview Platform — guides for interview creators and interviewees.",
};
    ...
    <>
      ...
      <footer className="border-t border-mk-border/60 px-8 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-xs text-mk-text-muted">
          <span>&copy; {new Date().getFullYear()} SMART Interview Platform. All rights reserved.</span>
